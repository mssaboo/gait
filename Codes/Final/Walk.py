...
# This code takes 3 input arguments.
# 1. File name
# 2. Start point
# 3. End point
...
##################################################################################################################################################
# computes for detection of events
...
while (a<limit):
    ...
    if((cp1<cp12)and(SAVZ[a]<-50)and(SAVZ[a]>SAVZ[a-1])):
        cp1=a
...
file=open('Error_Online_Walk.txt','a')
