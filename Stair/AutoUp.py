...
savz_ETS_time=[]
for i in ETS:
        savz_ETS.append(data.Toe[ETS])
        savz_ETS_time.append(data.Time[ETS])

#plt.plot(data.Time,data.SAVZ)
plt.ylim(-15,60)
plt.plot(data.Time,data.Toe,label='Toe')
plt.plot(savz_ETS_time,savz_ETS,'ro',markersize=7)
plt.plot(savz_ETS_time[0],savz_ETS[0],'ro',markersize=7,label='ETS')

savz_ETM=[]
savz_ETM_time=[]
for i in ETM:
        savz_ETM.append(data.Toe[ETM])
        savz_ETM_time.append(data.Time[ETM])

#plt.plot(data.Time,data.SAVZ)
plt.ylim(-15,60)
plt.plot(savz_ETM_time,savz_ETM,'g^',markersize=7)
plt.plot(savz_ETM_time[0],savz_ETM[0],'g^',markersize=7,label='ETM')

savz_MS=[]
savz_MS_time=[]
for i in MS:
        savz_MS.append(data.Toe[MS])
        savz_MS_time.append(data.Time[MS])

#plt.plot(data.Time,data.SAVZ)
plt.ylim(-15,60)
plt.plot(savz_MS_time,savz_MS,'ys',markersize=7)
plt.plot(savz_MS_time[0],savz_MS[0],'ys',markersize=7,label='EMS')
